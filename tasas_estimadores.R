# tasas general ----
  datos <- datos %>%
    mutate(
      ...
      ocupado_no_demandante_ni_disponible = fabs(condicion_actividad2,"Ocupado no demandante ni disponible", pondera),
  ...
  tasasG <- datos %>%
    ...
    summarise(
      ...
      subocupado_no_demandante = sum(subocupado_no_demandante) / poblacion_activa,
      subocupado = sum(poblacion_subocupada) / poblacion_activa,
      otro_ocupado_no_demandante = sum(otro_ocupado_no_demandante) / poblacion_activa,
      presion_trabajo = (sum(poblacion_desocupada) + sum(ocupado_demandante) +
                           sum(ocupado_no_demandante)) / poblacion_activa,
